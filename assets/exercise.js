export default [
	{
		...
		exercises: [
			{
				name: "Barbel Brench press",
				image: require('./img/1-1.png'),
				equipment: "Barbell, EZ-Bar",
				description: `Position yourself with your back down on a flat bench placing the hands up on the bar using an underhand grip slightly wider than shoulder width apart.
				...
				Continue until all reps are completed and then re-rack the barbell.`.replace(/\t+/g, "\n")
			},
			{
				...
				Finish the repetition with the cables together above your chest in the starting position.`.replace(/\t+/g, "\n")
			},
			{
				name: "Dumbbell Floor Chest Press",
				image: require('./img/1-3.png'),
				equipment: "Dumbbells",
				description: `Place a pair of dumbbells on the floor. Lie on your back in between the dumbbells. Bend your knees and move your feet towards your butt.
				...
				Slowly bring the weights down to the starting position, allowing your arms to rest for a brief moment before beginning the next repetition.`.replace(/\t+/g, "\n")
			},
			{
				name: "Dumbbell Flat Bench Press",
				image: require('./img/1-4.png'),
				equipment: "Dumbbells",
		...
		exercises: [
			{
				...
				image: require('./img/2-1.png'),
				equipment: "Full gym",
				description: `Sit on the ab machine and select a slight resistance. Position your feet under the pads and grab hold of the top handles.
				...
				Pause and slowly return to starting position as you inhale.`.replace(/\t+/g, "\n")
			},
			{
				name: "Reverse Crunch",
				image: require('./img/2-2.png'),
				equipment: "No Equipment",
				description: `Lie flat on an exercise mat on the floor.
			...
			},
			{
				...
				Once you are fully extended, pause, then slowly roll back up to the starting position. Rely on your core muscles to roll you out and pull you back in.`.replace(/\t+/g, "\n")
			},
			{
				name: "Barbell Windshield Wipers",
				image: require('./img/2-4.png'),
				equipment: "Barbell / EZ-Bar",
				description: `Hold a lightly-loaded barbell directly above your chest, and keep your back in full contact with the floor.
				...
				Lower both legs down to the central position; this completes one rep.`.replace(/\t+/g, "\n")
			},
		],
	},
	{
		...
		exercises: [
			{
				name: "Barbell Clean and Press / Jerk / Overhead Press",
				image: require('./img/3-1.png'),
				equipment: "Barbell / EZ-Bar",
				description: `Shoulder-width stance. Tight core and flat back. Bend at the knees and hips. Lower yourself. Arms fully extended. Chest up and gaze straight ahead.
				...
				Press the barbell above your head. Lower the bar.`.replace(/\t+/g, "\n")
			},
			{
				name: "Resistance Band Squat and Overhead Press",
				image: require('./img/3-2.png'),
				equipment: "Resistance Bands",
				description: `Begin the movement by stepping on to a resistance band with your feet at shoulder-width, toes pointed slightly out.
				...
				When you reach the top, push the resistance bands overhead. Slowly lower your hands and repeat the entire movement.`.replace(/\t+/g, "\n")
			},
			{
				name: "Medicine Ball Rotational Passes",
				image: require('./img/3-3.png'),
				equipment: "Medicine Ball",
				description: `Stand up straight with your left side to a wall or a partner.
				...
				Repeat the movement in rapid succession. Once finished, do it again on the right side.`.replace(/\t+/g, "\n")
			},
			{
				name: "Russian / Mason / V-Sit Twists",
				image: require('./img/3-4.png'),
				equipment: "No Equipment",
				description: `Lie on an exercise mat and place your feet your under something that will not move or ask a spotter hold them down for you. Keep your knees bent.
		...
		exercises: [
			{
				...
				image: require('./img/4-1.png'),
				equipment: "Barbell / EZ-Bar",
				description: `Begin by positioning a barbell at or just below shoulder level in the squat rack. Behind the squat rack, place a tall wooden box or chair. Place yourself underneath the barbell. Make sure the bar is across your upper traps and NOT on your neck.
				Place your feet outside of shoulder-width with your toes pointed slightly out. Brace your core and keep your chest up.
				Bend at the knees as you drive your hips back. Lower yourself slowly until your butt touches the box. Pause then drive your hips forward to return to the starting position.`.replace(/\t+/g, "\n")
			},
			{
				name: "Dumbbell Walking Lunges",
				image: require('./img/4-2.png'),
				equipment: "Dumbbells, Kettlebells",
				description: `Holding a pair of dumbbells at your sides, stand tall with your chest up and abdominals contracted. Begin the movement by stepping forward with the left foot.
				...
				The left knee will go towards the floor and you’ll bend the right knee. Continue this back and forth pattern. Be sure to keep the abdominals braced during the entire movement.`.replace(/\t+/g, "\n")
			},
			{
				name: "Duck Walks / Squats",
				image: require('./img/4-3.png'),
				equipment: "No Equipment",
				description: `Stand with your feet slightly wider than shoulder width apart. Bend your knees and bring yourself down into a squat until your thighs are parallel to the floor.
				...
				Quack quack.`.replace(/\t+/g, "\n")
			},
			{
				name: "Machine Hack Squats",
				image: require('./img/4-4.png'),
				equipment: "Full Gym",
				description: `Place your back flat against the back pad of the hack machine and position your shoulders under the shoulder pads.
